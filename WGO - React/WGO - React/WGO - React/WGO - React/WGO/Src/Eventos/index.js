...
export default function Eventos(){
    ...
    <View  style={estilo.containerEventos}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Pesquisa', { setCategoria: 'Restaurantes' })}>
    ...
    <ScrollView horizontal={true} scrollEnabled={true}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Pesquisa', { setCategoria: 'Passeios' })}>
            <View style={estilo.Categoria}>
